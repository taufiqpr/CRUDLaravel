            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="flex justify-between items-center mb-4">
                        <h2 class="text-2xl font-semibold">Daftar Konten Cerita</h2>
                        <a href="{{ route('stories.create') }}" class="btn btn-primary mb-3">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse ($stories as $index => $story)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4"><a href="{{ route('stories.show', $story->id) }}" class="text-blue-600 hover:underline">
                                            {{ $story->title }}
                                        </td>
                                        <td class="px-6 py-4">{{ $story->desc }}</td>                                        
                                        <td class="px-6 py-4">
                                            <a href="{{ route('stories.edit', $story->id) }}" class="text-blue-600 hover:underline mr-4">Edit</a>
